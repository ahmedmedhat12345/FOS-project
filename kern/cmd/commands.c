...
struct Command commands[] =
{
		...
		{ "schedPRIRR","to call the inialize funcation ",command_sched_PRIRR,3},
...
int command_sched_PRIRR(int number_of_arguments, char **arguments){
	uint32 nopr = strtol(arguments[1],NULL,10);
	uint32 quan = strtol(arguments[2],NULL,10);
	uint32 str = strtol(arguments[3],NULL,10);
	sched_init_PRIRR(nopr,quan,str);
	return 0;
}
